				...
				<DialogHeader>
					...
					<DialogDescription>
						...
						<p className="my-2 mt-4 ">
							...
							goodbye to the ordinary and embrace the
							extraordinary with Quizmefy! Our platform is
							revolutionizing the quiz and trivia experience by
							harnessing the immense potential of artificial
							intelligence.
						</p>
						<hr />
